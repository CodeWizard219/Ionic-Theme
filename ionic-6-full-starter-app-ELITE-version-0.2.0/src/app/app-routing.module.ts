...
const routes: Routes = [
  ...
  {
    path: "wordpress",
    loadChildren: () => import("./wordpress/posts/posts.module").then(m => m.WordpressPostsPageModule)
  },
  {
    path: "visualizations",
    loadChildren: () => import("./visualizations/visualizations.module").then(m => m.VisualizationsModule)
  },
  {
    path: '**',
